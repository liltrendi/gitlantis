import { SharedSelect } from "@/packages/components/select";
import { SharedSlider } from "@/packages/components/slider";
import type { useGameSettings } from "@/hooks/useGame/settings";
import { SharedColorPicker } from "@/packages/components/color-picker";
