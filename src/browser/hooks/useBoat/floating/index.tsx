...
export const useFloating = ({
	...
	useFrame((_, delta) => {
	  // Double check - don't float if any movement keys are pressed OR if motion detected
	  ...
	  if (shouldFloat) {
		...
		console.log('Floating disabled:', { isBoatMoving, anyKeyPressed }); // Debug log
		
		// CRITICAL: Reset X and Z rotations when movement starts
